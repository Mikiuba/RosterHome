...
if('serviceWorker' in navigator && location.protocol.startsWith('http')) navigator.serviceWorker.register('./service-worker.js?v=1.0.1',{updateViaCache:'none'}).then(r=>r.update()).catch(()=>{});
