...
if('serviceWorker' in navigator && location.protocol.startsWith('http')) navigator.serviceWorker.register('./service-worker.js?v=1.1.2',{updateViaCache:'none'}).then(r=>r.update()).catch(()=>{});
